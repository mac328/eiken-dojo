...
# ---- 色（アプリ本体と そろえています）----------------------------
# ホーム画面で 一目で 見つけられることを 優先し、
# 面の 色で 分かるように 背景を オレンジに した。
# 生成り地に 淡い山 だと、屋外の 明るい ところで
# 背景と 山が 溶けて 何の アイコンか 分からなかった。
BG = "#F59E0B"          # オレンジの 背景
HILL_BACK = "#FFFFFF"   # 山（うしろ）
HILL_FRONT = "#FFE3B0"  # 山（手まえ）
ARROW = "#7C3E00"       # 旗
TEXT_COLOR = "#4A2400"  # 「準2」の 文字。オレンジ地でも 読めるよう 濃くする

# ---- 文字 --------------------------------------------------------
TEXT = "準2"
TEXT_SIZE = 96          # デザイン空間(512)での 大きさ。小さいと 読めないので 大きめに
